...
if (isset($_POST['submit'])) { //si le bouton inscription a été pressé
    //print_r($_POST);
        ...
        if (!empty($_POST['nom']) AND !empty($_POST['prenom']) AND !empty($_POST['email']) AND !empty($_POST['mdp'])) { //si les champs ne sompt pas vide
/*requete pour insert un nouvel utilisateur*/
